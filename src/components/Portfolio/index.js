          ...
          <div className="col-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  CMS-style blog for writes to publish articles and stories
          ...
          <div className="col-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  App that allows users to search drink recipes by liquor and
                  save the favorite drinks they try.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  An app that gives users an easy eay to track their money on
                  and offline.
                </p>
              </div>
            </div>
